...
#define OUTPUT_DIR "C:\\Users\\iit_c\\Desktop\\scanner_socket\\socket_server\\app\\cpp\\scans"
...
int main( int argc, char **argv )
{
    ...
    std::cout << "Enter the number, how many frame would you like to generate? ";
    std::cin >> NumberOfFramesToCapture;

    // char input;

    // std::cout << "Do you want to enable texture mapping? (y/n): ";
    // std::cin >> input;

    // // Check user input and redefine ENABLE_TEXTURE_MAPPING accordingly
    // if (input == 'y' || input == 'Y') {
    //    // #undef ENABLE_TEXTURE_MAPPING
    //     #define ENABLE_TEXTURE_MAPPING
    ...
    //std::cout << "The value of abc is: " << NumberOfFramesToCapture << std::endl;
